...
/** The main results object returned from a call to pagefind.search() in a multisite setup */
export type PagefindIndexesSearchResults = {
  /** All pages that match the search query and filters provided */
  results: PagefindSearchResult[];
  /** How many results would there have been if you had omitted the filters */
  unfilteredResultCount: number;
...
export type PagefindSearchResult = {
   ...
   * (e.g. one page at a time, or in a scroll listener)
   */
...
export type PagefindVerboseWordLocation = {
...
/** The Pagefind module interface, as loaded via dynamic import */
